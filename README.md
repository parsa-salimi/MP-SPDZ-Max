...
THis is the repository for the [Mascot Private meeting scheduler]([paperlink](https://github.com/parsa-salimi/MP-SPDZ-Max/blob/master/CO_789_final.pdf)) ([slides here]([slideslink](https://github.com/parsa-salimi/MP-SPDZ-Max/blob/master/Jonathan%20Gold%20and%20Parsa.pptx))) , a meeting scheduler forked from MP-SPDZ. The readme files below are specific to MP-SPDZ. Refer to the ExternalIO folder for instructions on how to run our protocol.
